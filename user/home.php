...
<div class="body_area">
  <div class="wrapper">
    <div class="row">
      <div class="col-sm-3 col-md-3" style="padding-right: 13px;margin-left: 4%;">
        <div class="small_profile">
          <div class="upper_small_profile">
            <!-- cover photo area -->
            <img src="<?php echo 'cover_img/'.$cover_pic; ?>" height="95px" width="100%">
          </div>
          <div class="body_small_profile">
            <div class="row">
              ...
              <div class="col-md-8 user_area">
                <h4 style='font-size:14px;'><?php name($name); ?></h4>
                <p><?php user_id($email); ?></p>
              </div>
            </div>  <!--end of row -->
        ...
        <!-- end of small profile -->
        <!-- suggested friends area -->
        <div class="suggested_friends">
          <h3>People you may know<span>&nbsp;<small>.</small>&nbsp;<a href="">Send request</a></span></h3>
          <?php
            random_two_friends();
          ?>
          <!-- invite start here -->
          <div class="invite_friends">
            <div class="row">
              <div class="col-md-2 gmail_logo">
                <img src="images/gmail.png">
              </div>
              <div class="col-md-10">
                <h4><a href="#">Invite people you know</a></h4>
                <p>Invite your contacts from Gmail</p>
              </div>
            </div>
          </div>
          <!-- invite ends here -->
      ...
      <div class="col-sm-5 col-md-5" style="padding: 0px;">
        <div class="main_body_content">
          <!-- post a status -->
          <div class="status">
            <div class="upper_body_nav">
              <div class="row" style="">
                <div class="col-md-12 upper_compose">
                  <h4><i class="fas fa-pencil-alt"></i>&nbsp;Compose Post</h4>
                </div>
              </div>
            </div>
            <div class="uparrow_sec">
              <img src="images/small_uparrow.png">
            </div>
            <div class="textArea">
              <div class="row">
                <div class="col-md-1"></div>
                    ...
                    <div class="bodyMenu">
                      <div class="menu">
                        <div class="row" style="margin: 0;padding: 0;">
                          ...
                          <div class="col-md-2 main_body_menu">
                            <button class="btn create-btn" name="postImage" style="background: #1DA1F2;"><span style="color: #fff;">&nbsp;&nbsp;<i class="fas fa-share-square"></i>&nbsp;Share</span></button>
                          </div>
                          </form>
                          <!-- end of form -->
                        </div>
