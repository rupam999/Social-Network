  ...
  <div class="main_body">
    <div class="row" style="margin-right: 0;">
      <div class="col-md-9">
        ...
        ?>
        <?php
          getViewProfilePhotos();
        ?>
        <?php
          getViewProfileFriends();
        ?>
        <!-- copyright start -->
        <div class="copyright">
            <div class="content">
        ...
        <?php
          ...
          $u_id = $_GET['u_id'];
            ...
            $get_normal_view_friend_check = "SELECT * FROM friends WHERE rec_id=$user";
            $run_normal_view_friend_check = mysqli_query($con,$get_normal_view_friend_check);
            $friend = false;
            while($row_normal_view_friend_check = mysqli_fetch_array($run_normal_view_friend_check)){

              $friend_id = $row_normal_view_friend_check['friend_id'];
